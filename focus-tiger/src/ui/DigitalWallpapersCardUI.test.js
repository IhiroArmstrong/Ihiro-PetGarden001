...
import { DigitalWallpapersCardUI } from './DigitalWallpapersCardUI.js';
import { OVERLAY_BACKDROP_FADE_MS } from './overlayBackdrop.js';

describe('DigitalWallpapersCardUI overlay backdrop', () => {
  it('shows shared backdrop on open and hides on close / blank dismiss', () => {
    ...
    try {
      const ui = new DigitalWallpapersCardUI(mountRoot);
      assert.equal(ui.backdrop.id, 'digital-wallpapers-backdrop');
      assert.equal(ui.backdrop.dataset.testid, 'digital-wallpapers-backdrop');
