...
```bash
cd focus-tiger/cloud
npx wrangler kv namespace create GROWTH_METRICS_KV
npx wrangler kv namespace create GROWTH_METRICS_KV --preview
# 将输出的 id / preview_id 写入 wrangler.jsonc → GROWTH_METRICS_KV
```
