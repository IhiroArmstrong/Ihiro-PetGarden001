...
| How shall we sit? secondary 描边钮 | UI可见 | 待人工测试 | Sit 仍为蒲团橙主 CTA；旁「How shall we sit?」为**描边次要钮**（透明底+墨线），不抢 Sit。Honesty Bridge Yes/No **仍同级**（勿改成主次）。 | 2026-07-21：对齐 ui-kit secondary-button。 | `.session-start-dock__hint` · `#btn-focus` | 2026-07-21 |
