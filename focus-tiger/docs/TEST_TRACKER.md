...
| Ambient Soundscape / 静音图标 + Sound | UI可见 | 待人工测试 | **静音**：右上米色圆形 **音符钮**（在播=音符+斜杠，点一下即静音）。**Sound**：右下蒲团橙 **Sound** **始终可见**；**Sit 开计时后**可展开选曲/音量；未专注点 Sound 会提示先开始专注。**主路径**：默认 Mer-Ka-Ba；音符静音/恢复；专注后 Sound 换曲。**回流**：关→刷新仍关；Rise 后 Sound 仍可见但不可开面板。 | **2026-07-21**：用户书面——专注后 Sound 不见、需恢复选曲。已改 Sound **始终显示**（恢复旧版），面板仍门闩 FOCUSING。请硬刷新。 | 右上 `.ambient-soundscape__mute` · 右下 `.ambient-soundscape__fab` | 2026-07-21 |
