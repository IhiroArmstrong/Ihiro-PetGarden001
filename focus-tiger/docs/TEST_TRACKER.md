...
| MilestoneGlow · 琉璃星石变体（meditation-star-reward） | UI可见 | 待人工测试 | **实验室**：http://127.0.0.1:5175/ →「里程碑琉璃星石」。**须见**：不抠图整幅 + 镜头 **100% → ≈145.45%（16/11）** 刚好顶满 16:9 宽度（非原 158%）。硬刷新 tip。 | **2026-08-03**：抠图不行→不抠图；要拉近→playbackZoom；**同日**：终点改为顶满 16:9 宽 = 16/11。 | — | — | http://127.0.0.1:5175/ | 2026-08-03 |
