...
| Sleeping / DORMANT 睡态循环 | UI可见 | 已通过 | **自动（live）**：≥2h 回前台 / Rise 后进 DORMANT；披毯后睡姿为 **cloak-sleep 034→030 每帧两拍 pingpong** @ **2 fps**。**冷启动不进睡**。调试：「睡着了」→ 同 pingpong。 | **2026-07-22～26**：旧 cloak 节奏/衔接曾书面通过。**2026-08-04 用户书面**：点「睡着了」试 starlight 尾帧——**没有睡着的呼吸，不如原来的** → 产品接线 **Undo**。 | — | — | `?product=1` · `#emotion-debug-ui` | 2026-08-04 |
