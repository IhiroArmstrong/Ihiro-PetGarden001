...
| 场景 B · 鹦鹉稀有彩蛋（轻完成池） | UI可见 | 待人工测试 | **主路径**：微仪式完成或非首日计时完成 → 偶发（约 7%）播鹦鹉而非摆尾/点头。**须见**：仍**禁止** Celebrating 舞。**不**替代 streak-7 蝴蝶金辉 MilestoneGlow。**羽毛残影 / 可收集**：未做（待拍板；禁宠物收集叙事）。 | **2026-08-03**：进 `LIGHT_COMPLETE_POOL` weight 8；streak-7 仍 Glow。 | — | — | 微仪式 / 调试强制 random · `sceneAnimationDispatcher.test.js` | 2026-08-03 |
