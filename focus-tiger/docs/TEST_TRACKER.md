...
| 「一分钟呼吸」· SessionComplete 摆尾（禁 Celebrating） | UI可见 | 待人工测试 | 微仪式结束后只见 **摆尾**，**不见** Celebrating 舞；即便当日尚无正式 Focus 达标也如此。同日第二次微仪式仍只摆尾。 | **2026-07-22**：用户书面——一分钟呼吸结束后「好像只有撅屁摇尾，没有跳舞」；问是否原设计。**口径确认：是**（见 `MICRO_RITUAL_PLAN`：从不 Celebrating）。跳舞仅正式 Sit→计时**墙钟达标**当日首次。 | 同上 | 2026-07-22 |
