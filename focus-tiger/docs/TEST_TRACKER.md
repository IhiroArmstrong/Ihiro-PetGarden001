...
| Lit 试点 · OnboardingHintsUI（步 4） | UI可见 | 待人工测试 | **未开工代码**。Brief：`docs/task-briefs/task-lit-pilot-onboarding-hints.md`。开工后复测：清空已读 → affordance；点 ? → 本页全部锚点提示；尖角对准；回流再点 ?。**勿**动 Companion/Arrival/Emotion。 | 2026-07-21：试点目标由 Companion/Arrival **改为** OnboardingHints（按 DOM 灾区密度）。 | `#onboarding-hint-help` · Brief 同上 | 2026-07-21 |
