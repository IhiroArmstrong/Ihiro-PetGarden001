...
> **§6 可见性机器块**：由 `visibilityContractRegistry.js` 生成；`npm run visibility:doc-sync`；改 suppress/hide → `npm run test:e2e:visibility`。  
> **更新**：2026-07-26（§6 Visibility Contract Registry）
