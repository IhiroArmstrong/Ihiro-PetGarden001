...
| **0.D** | Yin Intent Diagnostic（只输出 intent JSON） | `LOCAL_AI_PHASE1_TASK_PLAN.md` §6.1 | **换模型前必做** | Phase 1 **已合 #495** · Phase 2 **已合 #509** · Metal 20 条 reading=pipeline（不换模型） · **Phase 2B v4 本旁支**（A/C/D Metal 未跑） |
