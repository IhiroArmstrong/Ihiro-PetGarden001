...
| **Slice 1a** | Consent 门闩 + userData store 骨架（`yin-personal-memory.json`） | `task-yin-memory-slice-1a-consent-store.md` | **本旁支开工** |
| **其后 1b–1d** | Remember / 列表+Forget / 层 3 注入 | 同口令分段 | 未开工；仪式 generate **仍未拍板** |
