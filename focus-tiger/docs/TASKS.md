...
| **L3** | **Yin's Collections** 抽屉；挥手点播 UI 后置 | `feature/yin-coin-l3-surface` | **#352+#353+#354 已合** |
| **本旁支** | `collectionsWaveHello` 引擎；抽屉仍清供 8 | `feature/focus-coins-wave-playback` | 进行中 |
...
| **实现** | 可选拉取 + 本地降级；不接 Sit 门闩 | 口令「开工云端品味层」 | **#349 已合**（生产须另「部署」） |
