...
| **L1** | 完成钩子写入钱包 | `feature/focus-coins-l1-award` | **#338 已合**（用户书面达标/未达标测 OK；TRACKER 未关单） |
| **L2** | 称号 / 稀有章 / 空间变体；须弥坐双门槛 | `feature/focus-coins-l2-redeem` | **#339 已合** |
| **L3** | 抽屉安静表面；en/ja；375 | `feature/focus-coins-l3-surface` | 待另口令 |
...
| **实现** | 可选拉取 + 本地降级；不接 Sit 门闩 | `feature/cloud-taste-layer` | **权重池切片开工**（日签正文另刀） |
