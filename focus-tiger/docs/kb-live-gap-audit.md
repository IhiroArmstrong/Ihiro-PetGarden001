...
**Snapshot**: 2026-09-22 · 25 live rows · 16 approved catalog ids
...
|---|---|---|---|
| `kb-live-five-moments` | live | ⋯ → Practice → Five Moments | `FIVE_MOMENTS_MENU_LABEL` |
| `kb-live-honesty` | live | ⋯ → Practice → Honest check-in | `HONESTY_IDLE_ENTRY` |
