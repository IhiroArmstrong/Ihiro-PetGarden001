...
- **Colophon / 版权（2026-08-16）**：简介卡**最末**（Got it 按钮下方）静默页脚 `.onboarding-app-purpose__colophon`：产品名 + Created by… / Twinsology + © 行。英文专有名词三语共用；**不是**可点控件。叙事：`PRODUCT_POSITIONING.md`「Ownership & credit」。
