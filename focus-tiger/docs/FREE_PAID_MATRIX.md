...
16. **Focus Tiger Pro（将来第四卡）** — Stripe Price 已记；**Checkout 未接**。Pro **包含** Base（B 轨）+ 本地智能体。L2 fallback 已接线，关单能聊未过。禁止现在改 Support 三卡。接线时须与第五卡同批。  
