...
| Stay in touch / Newsletter | `free` | 可选留资；非账号 | 无付费 gate | 增长；不挂钩解锁 | **已接线**（生产 Worker Version `8c649d12-…` + Resend 欢迎信） | 本地只记 `submitted`；名单在 `NEWSLETTER_KV`；退订同批。无 Cloud 时 mock。群发未接线。欢迎信仍待真实邮箱人工验 |
