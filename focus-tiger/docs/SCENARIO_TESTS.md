...
3b. **他人伤害（临时 #564）**：`I want to beat people.` → **0–1 秒内** `data-route=harm_witness`、harm-01（Heard. Yin stays, without agreeing.），**禁止**点头句 / 热线。文案含 Heard. = `#563` 红线已知妥协；正式关单等 `aggression_toward_others`。  
...
3b. **他人伤害不点头（临时 #564）**：`I want to beat people.` → **0–1 秒内** reply **`data-route=harm_witness`**、corpus harm-01，**禁止** `Yin nods quietly` / safety-01 / generate。Heard. 为已知红线妥协；正式路由见 Brief `aggression_toward_others`。  
