...
> **状态：方向锁（2026-08-18）** — 六项拍板已书面同意。**L0–L2 已接线**（账本 / 发点钩子 / 内部兑换）；无抽屉商店、不进练习备份 6 key。`?focusCoins=0` 关闸完全不写。  
...
| **L1 发点接线** | 完成一场坐，钱包会涨（可先无「店」） | 挂计时达标 / Honesty 呼吸成功 / Choose / Reflect / 主动 Recover；localStorage 白名单；flag 默认可关 | 无兑换 UI；不改场景剧本；不把钱包塞进练习备份 6 key | **4–6 人日 · 已合 #338**（高风险：Honesty / 完成记账邻接） |
| **L2 可兑原型** | 内部能花点留下痕迹 | 称号 + 稀有章 + 至少 1 个空间变体；稀缺款双条件；与 Tea/Sanctuary 章包隔离 | 新角色帧换装、完整纪念物美术、云备份升 schema | **4–6 人日 · 本支**（无新序列）；新点缀美术另 **+3–8** |
...
|---|---|---|---|---|---|---|---|
| **同坐点** | 2–4 人日 · 纯账本 **（L0 已合 #335）** | 4–6 · 发点钩子 **（L1 已合 #338）** | 4–6 · 兑换 **（L2 本支）** | 3–5 · 安静表面 | **10–16 人日 · 约 2.5–4 周** | L3 后；无第三方模型风险 | L2 兑换本支；L3 待合入 |
