...
| **b. 人设** | Honesty「别处也算数」；观察式文案 | 「赚/花」易变监工 | 对外「寅币」；不怀疑补登；不展示真假专注分 |
...
| **C · 寅币** | 练习换来的情感货币 | 只买身份/空间变体/称号/稀有练习章 |
...
6. **对外名「寅币」**（2026-08-18 晚书面覆盖「同坐点」），仍不叫积分。
...
| **L3 可给用户看的安静表面** | 抽屉「寅币」+ 装备称号 | i18n en/ja、375 抽屉不挡主球、0–1s 按压、只增不减回流；可选并入练习备份 schema v2 | 换装柜、场景 D 改写、B 轨任何 key | **3–5 人日** |
