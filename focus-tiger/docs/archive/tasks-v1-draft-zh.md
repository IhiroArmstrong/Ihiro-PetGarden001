...
> **⚠️ 历史注记（2026-07-15）**：本文件为第一版历史副本，原文保留不改写。文中所有"灰→金/渐染金/材质插值"相关表述均为当时方案，已被新视觉原则取代：角色本体固有色恒定不变，金色由外围光环/环境光反射（Rim Light）表达，见 `DESIGN.md`「视觉状态」章节。当前权威任务清单为 `docs/TASKS.md`。
