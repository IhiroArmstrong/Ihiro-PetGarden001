...
| Day1 / 久别（≥3 日）吹花鼓励 | `conjureFlowersBlowAway` + 观察式气泡 | ack | **Phase 2b 已接线**（`WELCOME_APP` 门闩） | **策略 C**。同日 XOR `welcome` 日旗。`?flowerWelcome=0` 可关。SSOT：`FLOWER_BLOW_WELCOME_DESIGN.md` |
