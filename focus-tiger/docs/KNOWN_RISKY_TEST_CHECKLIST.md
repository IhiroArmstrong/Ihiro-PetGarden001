...
| **P2** | **25–26** Tip Jar / Sanctuary | A 已合 UI 骨架；B 仅 gate 脚手架——测边界，勿当完整付费完成 |
...
| 25 | Buy Yin a Tea / Tip Jar（A） | known-risky | 【主路径】⋯/抽屉见 **Buy Yin a tea** → `#yin-tip-jar-card`。<br>【契约】请茶 **不**解锁 Sanctuary / 氛围全库 / 高级动画。<br>【回流】关卡后再开；核心 Sit 路径不被 tip 墙挡住。<br>【Stripe】Worker secrets 未部署时只验 UI/门闩，勿假称支付完成。 | PR #161 已合 develop；TRACKER 待人工；支付真链依赖 secrets | UI/零耦合走查；支付另环境 |
