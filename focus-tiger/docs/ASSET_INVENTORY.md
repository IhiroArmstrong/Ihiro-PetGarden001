...
**视觉契约（2026-07-26 · 修订）**：三球统一 **暖米/zabuton 米色立体底**（与产品壳 `--color-bg` / 暖米界面协调的 neumorphic 圆球）+ **金属金图腾**（火焰 / Enso / 捧心双手；金箔纹理，非亮橙平面）。禁止陶色重底抢角色蒲团；禁止亮橙图腾。缓存戳 `?v=4`（`NarrowIdleShell.js`）。
