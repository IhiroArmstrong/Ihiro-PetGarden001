...
- **YPE / 云端个人化（2026-08-26 方向锁 · L0/L1 · L2 契约 · Consent 过稿 · 身份键已拍）**：编排见 `YIN_PERSONALIZATION_ENGINE.md`；**≠** 品味层。L0/L1 全本地。L2 **契约**已合 #454。用户可见保留 **关即删**（`task-l2-personalization-consent.md`）。V1 身份 = 本机随机 profile ID，不复用备份 OTP。Worker **未开工**；禁止把核心路径绑云；禁止默认上传 Confide 原文
