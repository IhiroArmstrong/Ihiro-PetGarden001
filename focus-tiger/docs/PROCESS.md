...
- **芥子须弥纪念印（2026-08-11 · `feature/mustard-seed-seal`）**：统一练习 score≥21；计时完成仪式后首次出卡（ZH+EN+乐五斋诗稿+章）；其后菜单可重读。Brief `task-mustard-seed-seal.md`。TRACKER 待人工。
...
- **芥子须弥纪念印（2026-08-11 · `feature/mustard-seed-seal`）**：统一练习 score≥21；计时完成仪式后首次出卡（ZH 原诗 + EN + 乐五斋诗稿 + 章）；其后 ⋯/抽屉可重读。Brief `task-mustard-seed-seal.md`。TRACKER 待人工。
