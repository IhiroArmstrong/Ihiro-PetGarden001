...
- **工程加固四步（2026-07-21 拍板）**：见 `ARCHITECTURE.md` — ① JSDoc ② SessionUiGate ③ 回归锁 ④ Lit 试点 **`OnboardingHintsUI` 已接线**（`ft-onboarding-hint-bubble` + `lit`）；待人工复测尖角/补救全铺；禁止全仓 Lit / 动 Emotion·Idle
