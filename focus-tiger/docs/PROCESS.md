...
- **星光斗篷入睡 / 卸斗篷苏醒（2026-08-04 · 勿接归档）**：曾接线后 Undo；v3 换帧实验室试播后用户书面——**暂时都不能替换原斗篷**。产品始终/仍为 `cloak-sleep`；星光目录保留、试播钮已撤。拓展时段未接线。
...
- **星光斗篷拓展场景（2026-08-04 · 搁置）**：v3 书面未过关；拓展时段与换装均搁置，直至更好素材。
