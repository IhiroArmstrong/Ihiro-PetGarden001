...
- **付费 · 意愿漏斗本地统计（2026-08-12 · 本支）**：`MONETIZATION_INTENT_FUNNEL.md`；Support→CTA→Checkout→完成；实验室「意愿漏斗」；无第三方。
- **付费 · Ambient Deep 15s 试听（Gate #251 已合 · 可并行）**：Brief `task-ambient-deep-audition-15s.md`——转化层；开 `feature/ambient-deep-audition-15s`。
...
- **付费 · 场景化请茶气泡（#253 已合 tip `c10acb7`）**：达标 / 里程碑 → TipJar；本地日一次。
...
- **双轨付费实现（A Tea + B 进阶解锁）**（方向已锁；Unlock/Tip UI 已合；**Support 统一入口**已合；**场景化请茶 #253**已合；**意愿漏斗**本支；B 下 Lifetime ∪ Yin Membership；**下一**：Ambient 15s 试听 / Membership 订阅产品化等；见 `task-tech-direction-v1-shell-monetization.md`）
