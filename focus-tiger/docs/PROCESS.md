...
- **Ambient 深度曲 entitlement（2026-08-11 · `feature/ambient-entitlement-free-subset`）**：免费温暖 5 首；其余内置曲 B 锁；用户自传仍免费。TRACKER 新行待人工。
...
- **付费 · Ambient 深度曲 entitlement（2026-08-11 · 本支）**：免费温暖子集 5 首（Mer-Ka-Ba / Divine Life Society / Somnia Variation 3 / Dreamland / Frozen in Love）；其余内置曲须 B（Lifetime∪Membership）；用户自传仍免费；面板锁行 + `setTrack` 硬拒。权威 `FREE_PAID_MATRIX` / `ambientEntitlement.js`。
