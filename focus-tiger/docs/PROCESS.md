...
- **Local AI Phase 1（2026-09-01 · 1B shipping 本旁支）**：Gate 0.2 #472 已关单；口令 1B 扩 CI-00/02 描述性问法 + Temporal Compare（两窗并列、禁人格评判）。**1A Show memory / 1C validation 仍须分项口令、分 PR**。Forget 端到端见 tracker `qa-ag-slice-1e-forget-e2e`。
