...
- **Ambient 内置清单 +6 曲（2026-08-05 · PR #125）**：合入 tip；**关单**（tip 书面：6 曲可见可播 + Off/Rise 停播 OK）。邻接 UX（Rise 后曲目高亮 / 断点续播 / 面板靠右）→ PR #131 初版合 tip；**§6.14b 跟进**（音符开播 + 每曲 Play/Pause + Idle 靠右）fix 端口 **全部测试 OK**（2026-08-06），待合 tip。
