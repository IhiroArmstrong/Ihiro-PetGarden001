...
- **Local AI Phase 1（2026-09-01 · 1A Show memory 本旁支）**：Gate 0.2 #472 已关单；**1B #503 已合**。口令 1A 新增 CI-03 `query_memory_list`（Consent 诚实模板；不替代 What Yin remembers 面板；Forget CI-01 不重做）。**1C validation 仍须分项口令、分 PR**。Forget 端到端见 tracker `qa-ag-slice-1e-forget-e2e`。
