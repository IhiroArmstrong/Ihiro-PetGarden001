...
- **意愿漏斗 opt-in 回传（2026-08-12 · `feature/monetization-intent-funnel-opt-in`）**：Privacy 明示同意；默认关；匿名 counts → Worker；不挡支付。TRACKER 待人工。
...
- **Web 轻量版本更新提示（2026-08-12 拍板 · 实现 #263）**：仅发现新版本时左下轻提示 → 点一下刷新；非补丁包。Brief `task-web-soft-update-prompt.md`；本 docs PR 固化口径。
...
- **付费 · 意愿漏斗 opt-in 回传（本支 · 勿漏）**：Brief `task-monetization-intent-funnel-opt-in.md`——Privacy 明示同意；默认关；事件名复用本地漏斗；`feature/monetization-intent-funnel-opt-in`。
...
**最近拍板（2026-08-12）**：**Web 轻量版本更新提示**——先做「发现新版本 → 点一下刷新」；入口**仅在有新版本时出现**（不常驻）。**不是**补丁包下载；桌面壳真更新器等打包选型。非阻断（Focus/Arrival 不弹窗强刷）；与 Stripe 解耦；不做推送。Brief：`task-briefs/task-web-soft-update-prompt.md`。实现见 PR [#263](https://github.com/IhiroArmstrong/Ihiro-PetGarden001/pull/263)。
...
- **Web 轻量版本更新提示**（拍板 2026-08-12；实现见 [#263](https://github.com/IhiroArmstrong/Ihiro-PetGarden001/pull/263)；Brief `task-web-soft-update-prompt.md`；本 docs PR 固化口径）
