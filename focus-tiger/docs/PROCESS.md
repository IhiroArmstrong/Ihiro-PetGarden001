...
- **YPE / 云端个人化（2026-08-26 方向锁 · L0/L1 · L2 契约收口 · Consent 关即删）**：编排见 `YIN_PERSONALIZATION_ENGINE.md`；**≠** 品味层。L0/L1 全本地。L2 **契约**已合 #454。用户可见保留 **关即删**（草稿 `task-l2-personalization-consent.md`）。Worker **未开工**；禁止把核心路径绑云；禁止默认上传 Confide 原文
