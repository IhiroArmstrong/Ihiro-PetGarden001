...
| H3 | `Breath 和 Sit 有什么区别` | 命中 **0011** 区别短答；`呼吸练习在哪` / 左球入口问句命中 **0006** |
...
| 层 | 状态 |
|---|---|
| 条目权威 | `product-knowledge-base.md`：**20 条** `审核状态: 已通过` 可进检索闸门（含 **0006** 左球入口 · PO 2026-09-25 进 catalog）；0009 云备份仍未审核 |
