...
> **状态（2026-08-11）**：**Phase 1–2 已合 develop（#233 / #234）**。**Phase 3 进行中**：圣诞文案桶人审 `ok` + `winter-quiet-wash` 氛围 UI + 总开关/`contentReady` 已翻真；仅 **B 轨 entitled** 用户在节日窗可见。无新 PNG 姿态序列（poses 空）。  
...
| **3** | 圣诞节素材+文案人审 ok；验收清单；翻开关小范围/全量 | 总开关 **开**；圣诞节 `contentReady: true`；**本支**（`feature/seasonal-theme-phase3`） |
...
| Phase 3 | `feature/seasonal-theme-phase3` | **本支**：文案桶 + winter wash UI + 翻开关；须人工验窗内观感 |
