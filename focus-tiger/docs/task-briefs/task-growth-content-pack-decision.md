...
| **存图构图（2026-08-15）** | **上图下字明信片**（4:5 / 1080×1350）：上约 58% 为当日图库静帧（cover，脸偏上），下暖纸写金句 + `Focus Tiger · with Yin` + 日期。**不要**字压在阿寅脸上，也**不要**把对话框按钮/说明句画进 PNG。静帧加载失败则上半幅退回暗色底、下半幅仍出字。与 Wallpapers（整张静帧、无字）分职。 |
