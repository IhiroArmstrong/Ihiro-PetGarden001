...
| **Lifetime AI 加购（2026-08-20 · 方案 A · Checkout 未接）** | 已买 Sanctuary Lifetime → 一次性 **US$29.99** SKU **`companion.addon.lifetime`**（Price **`price_1U6GnXFuIhgJPGLiNlXs0IKe`**；**不**订阅）。**禁止**写入 `FEATURE_CATALOG` / `isEntitled`。**不**拆 Ultimate Lifetime。权威：`FREE_PAID_MATRIX` A6 |
