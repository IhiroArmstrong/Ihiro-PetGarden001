...
> **状态（2026-08-20）**：范围 / 窄冻结 / **四问筛选尺**已拍板；**#349 已合** schemaVersion 1 可选 overlay（tip `a0fed0b`）。**本机 wrangler deploy 成功**：生产 Version **`5b5b3451-4c35-4d9b-b27b-622b72ed673e`**；现网 JSON 含 `schemaVersion: 1`。Safari `__tasteLayer.status()` 已见 true。**A/B**：`?tasteLayer=0` Arrival 叠化正常；overlay 开着闪（`RB-20260820-L330`）。下一刀 Quiet Line overlay **未开工**。  
