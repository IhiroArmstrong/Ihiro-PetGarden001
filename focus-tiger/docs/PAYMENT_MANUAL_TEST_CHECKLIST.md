...
2. 卡面点购买 → Stripe Checkout → 付 **约 US$4.99**（卡面 `TIP_JAR_PRICE_USD`；Worker `STRIPE_PRICE_ID`=`price_1U4nanFuIhgJPGLidoTdxobW`；生产 Version `fb568e27-96dd-4fb1-b15c-acbac8dd919b`）  
